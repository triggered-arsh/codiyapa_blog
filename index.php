...
<link rel="stylesheet" href="blog.css">
    <title> CoDiYaPa-Blogger A Platform that needs every blogger</title>
  </head>
  <body>
   <?php
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="https://source.unsplash.com/1600x600/?writting,blog" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="https://source.unsplash.com/1600x600/?travel, blog" alt="Second slide">
      <div class="carousel-caption d-none d-md-block">
    <h5> Create Your Blog Easily Now.</h5>
    <p>Just by visiting CoDiYaPa Bloggers.</p>
  </div>

    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="https://source.unsplash.com/1600x600/?food,Blogging" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
    <h5> Unlimited Blogs with the CoDiYaPa-Bloggers</h5>
    <p>Create Blogs as many as you can or want.</p>
  </div>
		...
		<div class="container">
			<div class="row">
				<div class="hero-header-content">
					<p>Let's Blog with us </p>
					<h1>   The heaven for<br> <b> Bloggers</b></h1>
					<p>
        <CoDiYaPa-Blogger><i> CoDiYaPa-Blogger </i> is a website which lets you submit an article which upon approval will be up on our website and you can get a good amount of reach from here!
