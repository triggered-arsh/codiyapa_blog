...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true) {
    # code...
 echo'   <form class="form-inline my-2 my-lg-0"action="partials/search.php" method="get">
  ...
  echo'<form class="form-inline my-2 my-lg-0"action="partials/search.php" method="get">
    ...
    <button class="btn btn-success mx-2"data-toggle="modal" data-target="#signupmodal" href="/_signuplogin.php">SignUp</button>';
  }
 echo' </div>
</div>
</nav>';
